...
namespace NMasters.Silverlight.Net.Http.Content
{
    ...
    public class ObjectContent : HttpContent
    {
        ...
        {
            return _formatter.WriteToStreamAsync(ObjectType, Value, stream, this);
        }
        ...
        private void VerifyAndSetObject(object value)
        {
            ...
            if (value == null)
            {
                ...
                {
                    throw Error.InvalidOperation(FSR.CannotUseNullValueType, typeof(ObjectContent).Name, ObjectType.Name);
                }
            }
            else
            {
                ...
                {
                    throw Error.Argument("value", FSR.ObjectAndTypeDisagree, objectType.Name, ObjectType.Name);
                }
            }
