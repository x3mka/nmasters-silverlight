...
namespace NMasters.Silverlight.Net.Http.Formatting
{
    ...
    public abstract class MediaTypeFormatter
    {
        ...
        {
            throw Error.NotSupported(FSR.MediaTypeFormatterCannotRead, GetType().Name);
        }
        ...
        {
            throw Error.NotSupported(FSR.MediaTypeFormatterCannotWrite, GetType().Name);
        }
        ...
        private static int InitializeDefaultCollectionKeySize()
        {
            ...
            return DefaultMaxHttpCollectionKeys;
        }
        ...
        public Encoding SelectCharacterEncoding(HttpContentHeaders contentHeaders)
        {
            ...
            if (encoding == null)
            {
                ...
                throw Error.InvalidOperation(FSR.MediaTypeFormatterNoEncoding, GetType().Name);
            }
        ...
        public virtual void SetDefaultContentHeaders(Type type, HttpContentHeaders headers, MediaTypeHeaderValue mediaType)
        {
            ...
            if (mediaType != null)
            {
                headers.ContentType = (MediaTypeHeaderValue)mediaType.Clone();
            }
            ...
            if (headers.ContentType == null)
            {
                ...
                {
                    headers.ContentType = (MediaTypeHeaderValue)defaultMediaType.Clone();
                }
            }
        ...
        private static Type GetOrAddDelegatingType(Type type, Type genericType)
        {
            return _delegatingEnumerableCache.GetOrAdd(
                ...
                (typeToRemap) =>
                {
                    ...
                    _delegatingEnumerableConstructorCache.TryAddValue(delegatingType, delegatingConstructor);
        ...
        internal class MediaTypeHeaderValueCollection : Collection<MediaTypeHeaderValue>
        {
            ...
            private static void ValidateMediaType(MediaTypeHeaderValue item)
            {
                ...
                {
                    throw Error.Argument("item", FSR.CannotUseMediaRangeForSupportedMediaType, _mediaTypeHeaderValueType.Name, item.MediaType);
                }
            }
        }
    }
