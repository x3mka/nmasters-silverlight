...
{
    /// <summary>
    /// An abstract base class used to create an association between <see cref="HttpResponseMessage"/> or 
    /// <see cref="HttpRequestMessage"/> instances that have certain characteristics 
