...
{
    /// <summary>
    /// This class provides a mapping from an arbitrary HTTP request header field to a <see cref="MediaTypeFormatter"/>
    /// used to select <see cref="HttpRequestMessage"/> instances for handling the entity body of an <see cref="HttpResponseMessage"/>
    /// or <see cref="HttpRequestMessage.Headers"/>.
    /// <remarks>This class only checks header fields associated with <see cref="HttpRespoHttpRequestMessage match. It does
    /// not check header fields associated with <see cref="HttpResponseMessage"/> or <see cref="MediaTypeHttpContentnces.</remarks>
    /// </summary>
