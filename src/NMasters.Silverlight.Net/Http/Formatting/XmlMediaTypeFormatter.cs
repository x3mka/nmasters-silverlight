    ...
    public class XmlMediaTypeFormatter : MediaTypeFormatter
    {
        ...
        public override Task<object> ReadFromStreamAsync(Type type, Stream readStream, HttpContent content, IFormatterLogger formatterLogger)
        {
            ...
            return TaskHelpers.RunSynchronously<object>(() =>
            {
                ...
                try
                {
                    ...
                    // SL: CreateTextReader doesn't have encoding param (effectiveEncoding)
                    using (XmlReader reader = XmlDictionaryReader.CreateTextReader(new NonClosingDelegatingStream(readStream), _readerQuotas))
                    {
                        ...
                        {
                            var xmlObjectSerializer = (XmlObjectSerializer)serializer;
        ...
        private object GetSerializerForType(Type type)
        {
            ...
            if (serializer == null)
            {
                ...
                throw Error.InvalidOperation(FSR.SerializerCannotSerializeType,
                              UseXmlSerializer ? typeof(XmlSerializer).Name : typeof(DataContractSerializer).Name,
                              type.Name);
            }
