...
namespace NMasters.Silverlight.Net.Http.Internal
{
    internal static class HttpRuleParser
    {
        ...
        internal static readonly Encoding DefaultHttpEncoding = Encoding.UTF8;
            ...
            while (num < input.Length)
            {
                ...
                if (supportsNesting && (input[num] == openChar))
                {
                    ...
                    try
                    {
                        ...
                        int num3 = 0;
                        switch (GetExpressionLength(input, num, openChar, closeChar, supportsNesting, ref nestedCount, out num3))
                        {
